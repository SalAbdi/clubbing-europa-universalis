...
NDiplomacy = {
	...
	MONTHS_BEFORE_TOTAL_OCCUPATION = 2,			-- Before this many months have passed in the war, you cannot gain 100% warscore by just occupying the warleader
...
NCountry = {
	...
	PS_MOVE_CAPITAL_DISTANCE_CAP = 50,				-- How much this penalty is allowed to cost in Adm.
	...
	BASE_TARIFF = 0,								-- Basic part of colonies income that goes to tariffs
